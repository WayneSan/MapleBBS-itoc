...
#define BRD_L_BIT	0x01	/* 可列，list */
#define BRD_R_BIT	0x02	/* 可讀，read */
#define BRD_W_BIT	0x04	/* 可寫，write */
#define BRD_X_BIT	0x08	/* 可管，execute，板主、看板總管 */
#define BRD_M_BIT	0x10	/* 可理，manage，板主 */

#define BRD_V_BIT	0x20	/* 已經逛過了，visit ==> 看過「進板畫面」 */
#define BRD_H_BIT	0x40	/* .BRH 中有閱讀記錄 (history) */
#define BRD_Z_BIT	0x80	/* .BRH zap 掉了 */


/* for user's gem permission level record */

#define GEM_W_BIT	0x01	/* 可寫，write，板主，看板總管 */
#define GEM_X_BIT	0x02	/* 可管，execute，站長 */
#define GEM_M_BIT	0x04	/* 可理，manage，板主 */
